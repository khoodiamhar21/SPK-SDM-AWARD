<x-app-layout>
    @if($periodeAktif)
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <a href="{{ route('panel.ranking') }}" class="group bg-white rounded-xl shadow-sm border p-6 hover:border-blue-400 hover:shadow-md transition-all">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="font-semibold text-slate-800 text-lg">Validasi Penilaian</div>
                        <div class="text-sm text-slate-500">Setujui hasil ranking penilaian SDM Award.</div>
                    </div>
                </div>
            </a>
        </div>
