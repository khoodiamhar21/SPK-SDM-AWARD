<x-app-layout>
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('panel.validasi.kelas') }}" class="text-sm text-blue-600 hover:underline">← Pilih Kelas</a>
    </div>
            ...
            <tbody class="divide-y">
                @forelse($siswas as $s)
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-4 py-3 text-right"><a href="{{ route('panel.validasi.prestasi', $s) }}" class="text-blue-600 hover:underline">Lihat Prestasi</a></td>
                    </tr>
                @empty
                    <tr><td colspan="4" class="px-4 py-6 text-center text-slate-500">Belum ada siswa dengan prestasi di periode ini.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
