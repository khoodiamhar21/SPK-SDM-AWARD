<x-app-layout>
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-slate-500">Master siswa (NIS). Siswa bisa register jika NIS terdaftar.</p>
        </div>
    </div>
    ...
    <form method="GET" class="mb-4 flex items-center gap-2 text-sm">
        ...
        <a href="{{ route('panel.siswa.create') }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-blue-600 text-white text-sm font-medium hover:bg-blue-700 ml-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border overflow-hidden">
        <table class="w-full text-sm">
            <thead class="bg-slate-50 text-slate-500"><tr>
                ...
                <th class="px-4 py-3 text-left">NIS</th><th class="px-4 py-3 text-left">Nama</th>
