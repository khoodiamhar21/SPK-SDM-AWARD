...
<head>
    ...
    <title>Server Error — SDM Award</title>
    @vite(['resources/css/app.css'])
</head>
<body class="font-sans antialiased bg-slate-50 text-slate-800 flex items-center justify-center min-h-screen">
    <div class="text-center px-6">
        <div class="text-7xl font-extrabold text-red-500">500</div>
        <h1 class="text-xl font-semibold text-slate-700 mt-4">Terjadi Kesalahan</h1>
        <p class="text-slate-500 mt-2">Mohon maaf, terjadi kesalahan pada server. Silakan coba beberapa saat lagi.</p>
