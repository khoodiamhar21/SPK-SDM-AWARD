...
<head>
    ...
    <title>Halaman Tidak Ditemukan — SDM Award</title>
    @vite(['resources/css/app.css'])
</head>
<body class="font-sans antialiased bg-slate-50 text-slate-800 flex items-center justify-center min-h-screen">
    <div class="text-center px-6">
        <div class="text-7xl font-extrabold text-slate-300">404</div>
        <h1 class="text-xl font-semibold text-slate-700 mt-4">Halaman Tidak Ditemukan</h1>
        <p class="text-slate-500 mt-2">Halaman yang Anda cari tidak ada atau telah dipindahkan.</p>
